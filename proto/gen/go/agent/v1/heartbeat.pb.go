...
type HeartbeatResponse struct {
	...
	PendingClientCertPem          string `protobuf:"bytes,13,opt,name=pending_client_cert_pem,json=pendingClientCertPem,proto3" json:"pending_client_cert_pem,omitempty"`
	PendingClientCertNotAfterUnix int64  `protobuf:"varint,14,opt,name=pending_client_cert_not_after_unix,json=pendingClientCertNotAfterUnix,proto3" json:"pending_client_cert_not_after_unix,omitempty"`
...
func (x *HeartbeatResponse) GetPendingClientCertPem() string {
	if x != nil {
		return x.PendingClientCertPem
	}
	return ""
}

func (x *HeartbeatResponse) GetPendingClientCertNotAfterUnix() int64 {
	if x != nil {
		return x.PendingClientCertNotAfterUnix
	}
	return 0
}

func (x *HeartbeatResponse) GetAgentCaCertPem() string {
	if x != nil {
